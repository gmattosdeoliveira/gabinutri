    ...
    const J = [
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function o(t) {
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || (n.activeElement && n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase())))) {
                    ...
                    e.isHorizontal()
                        ? ((d || p || c || u) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)), (((p || u) && !s) || ((d || c) && s)) && e.slideNext(), (((d || c) && !s) || ((p || u) && s)) && e.slidePrev())
                ...
                if (
                    ...
                    if (
                        (s.dynamicBullets &&
                            ...
                            s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((n += c - (e.previousIndex - e.loopedSlides || 0)), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)),
                            (i = Math.max(c - n, 0)),
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            function x(t) {
                ...
                u.$imageEl &&
                    0 !== u.$imageEl.length &&
                    ((r.scale = Math.max(Math.min(r.scale, u.maxRatio), i.minRatio)), u.$imageEl.transition(e.params.speed).transform(`translate3d(0,0,0) scale(${r.scale})`), (p = r.scale), (c = !1), 1 === r.scale && (u.$slideEl = void 0));
            }
            function y(t) {
                const s = e.zoom;
